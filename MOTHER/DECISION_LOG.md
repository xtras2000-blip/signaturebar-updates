...
|D-017|1차 플랫폼 모바일 앱(iOS/Android, 세로 화면·한 손 탭 조작), PC(Steam)는 2차 이식 검토. D-006의 PC 1차 결정 폐기|사용자 확인: 본 프로젝트는 핸드폰 앱 기준. 재생일 5~8분 단위(D-016)도 모바일 세션 패턴과 부합|01, 09, 10|Confirmed|
